...
CREATE TABLE GRUPO (
	...
	, CONSTRAINT FK_GRUPO_USUARIO FOREIGN KEY (IDUSUARIO) REFERENCES USUARIO (IDUSUARIO) ON DELETE SET NULL ON UPDATE CASCADE
)ENGINE = InnoDB;
...
CREATE TABLE INTEGRANTE (
	...
	, CONSTRAINT FK_INTEGRANTE_GRUPO FOREIGN KEY (IDGRUPO) REFERENCES GRUPO (IDGRUPO) ON DELETE CASCADE ON UPDATE CASCADE
	, CONSTRAINT FK_INTEGRANTE_USUARIO FOREIGN KEY (IDUSUARIO) REFERENCES USUARIO (IDUSUARIO) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE = InnoDB;
